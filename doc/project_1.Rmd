...
```{r load_libraries, warning=FALSE, echo=FALSE, eval=FALSE}
library(word2vec)
library(uwot)
library(tidytext)
library(tidyverse)
...
```{r speech tagging and lemmatizing, echo=FALSE, eval=FALSE}
...
```{r per gender, echo=FALSE, eval=FALSE}
...
```{r save image, echo=FALSE, eval=FALSE}
